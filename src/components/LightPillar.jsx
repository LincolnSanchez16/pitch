...
function LightPillar({
  ...
  }, [glowAmount, intensity, interactive, mixBlendMode, noiseIntensity, pillarHeight, pillarRotation, pillarWidth, quality, topColor, bottomColor, webGLSupported])
  ...
  return (
    <div
      ref={containerRef}
      className={['light-pillar-container', className].filter(Boolean).join(' ')}
      style={{ mixBlendMode }}
    />
  )
}
